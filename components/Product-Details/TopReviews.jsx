    ...
    <div className="col-span-9">
      ...
      <article>
        <div className="mb-4 mt-6 flex items-center space-x-4">
          <Image height={100} width={100} className="h-10 w-10 rounded-full" src="/image2.jpeg" alt="" />
        ...
        <p className="mb-2 text-left text-sm tracking-tight text-gray-500 dark:text-gray-400">
      ...
      <article>
        <div className="mb-4 mt-6 flex items-center space-x-4">
          <Image width={100} height={100} className="h-10 w-10 rounded-full" src="/image2.jpeg" alt="" />
          <div className="space-y-1 font-medium dark:text-white">
            <p>
              Jese Leos{" "}
              <time
      ...
      <div className="mt-6 border border-b-0 border-black sm:col-span-12 md:col-span-8 lg:col-span-9"></div>
    </div>
  );
}
